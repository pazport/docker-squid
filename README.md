...
```bash
docker pull  man1234/dockersquid:latest
```

Alternatively you can build the image yourself.

```bash
docker build -t sman1234/dockersquid github.com/pazport/docker-squid/
```
